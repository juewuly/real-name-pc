(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("React"), require("Immutable"), require("Redux"), require("ReactDOM"));
	else if(typeof define === 'function' && define.amd)
		define(["React", "Immutable", "Redux", "ReactDOM"], factory);
	else if(typeof exports === 'object')
		exports["RealNamePc"] = factory(require("React"), require("Immutable"), require("Redux"), require("ReactDOM"));
	else
		root["RealNamePc"] = factory(root["React"], root["Immutable"], root["Redux"], root["ReactDOM"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__0__, __WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__4__, __WEBPACK_EXTERNAL_MODULE__6__) {
...
var _Provider = _interopRequireDefault(__webpack_require__(34));

exports.Provider = _Provider["default"];

var _connectAdvanced = _interopRequireDefault(__webpack_require__(16));
...
var _middleware = __webpack_require__(51);
...
var _useIsomorphicLayoutEffect = __webpack_require__(18);
...
var _verifyPlainObject = _interopRequireDefault(__webpack_require__(21));
...
var _isPlainObject = _interopRequireDefault(__webpack_require__(42));

var _warning = _interopRequireDefault(__webpack_require__(22));
...
var _useReduxContext2 = __webpack_require__(24);
...
var _combineReducers2 = __webpack_require__(59);
...
var _mapDispatchToProps = _interopRequireDefault(__webpack_require__(41));

var _mapStateToProps = _interopRequireDefault(__webpack_require__(43));

var _mergeProps = _interopRequireDefault(__webpack_require__(44));

var _selectorFactory = _interopRequireDefault(__webpack_require__(45));
...
var _verifySubselectors = _interopRequireDefault(__webpack_require__(46));
...
var _utilities = __webpack_require__(60);
...
var _getStateName2 = __webpack_require__(27);

var _getStateName3 = _interopRequireDefault(_getStateName2);

var _getUnexpectedInvocationParameterMessage2 = __webpack_require__(61);

var _getUnexpectedInvocationParameterMessage3 = _interopRequireDefault(_getUnexpectedInvocationParameterMessage2);

var _validateNextState2 = __webpack_require__(62);
...
var _getStateName = __webpack_require__(27);
...
var react_hot_loader = __webpack_require__(33);
...
var initialState_initialState = external_Immutable_default.a.fromJS({
  global: {
    show: false
  },
  popup: {
...
var updateGlobalData_reducer = function reducer(state, action) {
  switch (action.type) {
    case UPDATE_GLOBAL_DATA:
      return state.mergeIn([KEY], Object(external_Immutable_["fromJS"])(action.data));
...
var updatePopupData_reducer = function reducer(state, action) {
  switch (action.type) {
    case UPDATE_POPUP_DATA:
      return state.mergeIn([updatePopupData_KEY], Object(external_Immutable_["fromJS"])(action.data));
...
var setPopupData_reducer = function reducer(state, action) {
  switch (action.type) {
    case SET_POPUP_DATA:
      return state.setIn([setPopupData_KEY], Object(external_Immutable_["fromJS"])(action.data));
...
function configureStore(initialState) {
  var store = Object(external_Redux_["createStore"])(rootReducer, initialState, Object(external_Redux_["compose"])(external_Redux_["applyMiddleware"].apply(void 0, middlewares), devToolsExtension));
...
var Modal_Modal = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      return external_ReactDOM_default.a.createPortal(children, this.wrap);
    }
  }]);
...
var components_Tip = __webpack_require__(65);
...
var Tip_Tip = function Tip(_ref) {
  ...
  }, /*#__PURE__*/external_React_default.a.createElement("div", null, /*#__PURE__*/external_React_default.a.createElement("h3", {
    className: "tip__title"
  }, title), subTitle && /*#__PURE__*/external_React_default.a.createElement("h3", {
    className: "tip__title"
  }, subTitle), subTitle2 && /*#__PURE__*/external_React_default.a.createElement("h3", {
    className: "tip__title"
  }, subTitle2), /*#__PURE__*/external_React_default.a.createElement("main", {
    className: "tip__content"
  }, /*#__PURE__*/external_React_default.a.createElement("p", null, content))), canClose && /*#__PURE__*/external_React_default.a.createElement("i", {
    onClick: onClose,
...
var views_Home = __webpack_require__(67);
...
var Home_Home = /*#__PURE__*/function (_Component) {
  ...
  Home_createClass(Home, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/external_React_default.a.createElement(src_components_Modal, {
        noMask: noMask
      }, /*#__PURE__*/external_React_default.a.createElement(src_components_Tip, {
        title: title,
        subTitle: subTitle,
        subTitle2: subTitle2,
        content: content,
...
var Home_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    actions: Object(external_Redux_["bindActionCreators"])({
...
var app_App = function App() {
  return /*#__PURE__*/external_React_default.a.createElement(src_views_Home, null);
};
...
var real_name_pc_renderApp = function renderApp(Component) {
  Object(external_ReactDOM_["render"])( /*#__PURE__*/external_React_default.a.createElement(react_hot_loader["AppContainer"], null, /*#__PURE__*/external_React_default.a.createElement(lib["Provider"], {
    store: real_name_pc_store
  }, /*#__PURE__*/external_React_default.a.createElement(Component, null))), document.getElementById('real-name-pc'));
};
