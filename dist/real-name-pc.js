...
var _Provider = _interopRequireDefault(__webpack_require__(370));

exports.Provider = _Provider["default"];

var _connectAdvanced = _interopRequireDefault(__webpack_require__(153));
...
var $$observable = _interopDefault(__webpack_require__(377));
...
var iterableToArrayLimit = __webpack_require__(429);
...
var _sync = __webpack_require__(389);
...
var _interopRequireWildcard = __webpack_require__(150);
...
var _hoistNonReactStatics = _interopRequireDefault(__webpack_require__(373));

var _react = _interopRequireWildcard(__webpack_require__(3));

var _reactIs = __webpack_require__(154);

var _Subscription = _interopRequireDefault(__webpack_require__(112));

var _useIsomorphicLayoutEffect = __webpack_require__(155);
...
var _verifyPlainObject = _interopRequireDefault(__webpack_require__(158));
...
var _isPlainObject = _interopRequireDefault(__webpack_require__(381));

var _warning = _interopRequireDefault(__webpack_require__(159));
...
var _useReduxContext2 = __webpack_require__(161);
...
var buildFullPath = __webpack_require__(416);
...
var _combineReducers2 = __webpack_require__(398);
...
var _global = _interopRequireDefault(__webpack_require__(353));
...
$export($export.S + $export.F * !__webpack_require__(17), 'Object', { defineProperties: __webpack_require__(118) });
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(24)(proto, TO_PRIMITIVE, __webpack_require__(267));
...
module.exports = __webpack_require__(85).f('asyncIterator');
...
module.exports = __webpack_require__(147).global;
...
var l=__webpack_require__(149),n="function"===typeof Symbol&&Symbol.for,p=n?Symbol.for("react.element"):60103,q=n?Symbol.for("react.portal"):60106,r=n?Symbol.for("react.fragment"):60107,t=n?Symbol.for("react.strict_mode"):60108,u=n?Symbol.for("react.profiler"):60114,v=n?Symbol.for("react.provider"):60109,w=n?Symbol.for("react.context"):60110,x=n?Symbol.for("react.forward_ref"):60112,y=n?Symbol.for("react.suspense"):60113,z=n?Symbol.for("react.memo"):60115,A=n?Symbol.for("react.lazy"):
...
*/
var aa=__webpack_require__(3),n=__webpack_require__(149),r=__webpack_require__(368);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
var _mapDispatchToProps = _interopRequireDefault(__webpack_require__(376));

var _mapStateToProps = _interopRequireDefault(__webpack_require__(382));

var _mergeProps = _interopRequireDefault(__webpack_require__(383));

var _selectorFactory = _interopRequireDefault(__webpack_require__(384));
...
var _wrapMapToProps = __webpack_require__(157);
...
var _ponyfill = __webpack_require__(380);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(378), __webpack_require__(379)(module)))
...
var _verifySubselectors = _interopRequireDefault(__webpack_require__(385));
...
var _utilities = __webpack_require__(399);
...
var _getUnexpectedInvocationParameterMessage2 = __webpack_require__(400);

var _getUnexpectedInvocationParameterMessage3 = _interopRequireDefault(_getUnexpectedInvocationParameterMessage2);

var _validateNextState2 = __webpack_require__(401);
...
var utils = __webpack_require__(22);
var bind = __webpack_require__(167);
var Axios = __webpack_require__(408);
...
var asyncToGenerator = __webpack_require__(82);
...
var react_hot_loader = __webpack_require__(179);
...
// CONCATENATED MODULE: ./src/sdk/config/statePath/base/index.js
...
var base_base = /*#__PURE__*/function () {
  function base() {
    ...
    this._rootPath = [ids_ids.rootNodeOfStore];
  }
...
var statePath_statePath = /*#__PURE__*/function (_base) {
  ...
  createClass_default()(statePath, [{
    key: "getPathByFeature",
    value: function getPathByFeature(feature) {
      return [].concat(toConsumableArray_default()(this.rootPath), [feature]);
    }
  }, {
    key: "getRootPath",
    value: function getRootPath() {
...
var updateGlobalData_reducer = function reducer(state, action) {
  switch (action.type) {
    case UPDATE_GLOBAL_DATA:
      return state.mergeIn(updateGlobalData_statePath, Object(immutable["fromJS"])(action.data));
...
var updatePopupData_statePath = [features_features.h5Platform, 'popup'];
...
var updatePopupData_reducer = function reducer(state, action) {
  switch (action.type) {
    case UPDATE_POPUP_DATA:
      return state.mergeIn(updatePopupData_statePath, Object(immutable["fromJS"])(action.data));
...
var setPopupData_statePath = [features_features.h5Platform, 'popup'];
...
var setPopupData_reducer = function reducer(state, action) {
  switch (action.type) {
    case SET_POPUP_DATA:
      return state.setIn(setPopupData_statePath, Object(immutable["fromJS"])(action.data));
...
var updateRealNameData_statePath = [features_features.h5Platform, 'realName'];
...
var updateRealNameData_reducer = function reducer(state, action) {
  switch (action.type) {
    case UPDATE_REAL_NAME_DATA:
      return state.mergeIn(updateRealNameData_statePath, Object(immutable["fromJS"])(action.data));
...
var fatherPath = [features_features.h5Platform, 'realName'];
...
var fetchRealName_reducer = function reducer(state, action) {
  switch (action.type) {
    case FETCH_REAL_NAME_BEGIN:
      return state.setIn([].concat(fatherPath, ['fetch', 'fetching']), true);

    case FETCH_REAL_NAME_SUCCESS:
      return state.set.apply(state, fatherPath.concat(['fetch', Object(immutable["fromJS"])({
        fetching: false,
        data: action.data
      })]));
...
var addRealName_fatherPath = [features_features.h5Platform, 'realName'];
...
var addRealName_reducer = function reducer(state, action) {
  switch (action.type) {
    case ADD_REAL_NAME_BEGIN:
      return state.setIn([].concat(addRealName_fatherPath, ['add', 'posting']), true);

    case ADD_REAL_NAME_SUCCESS:
      return state.setIn([].concat(addRealName_fatherPath, ['add']), Object(immutable["fromJS"])({
        posting: false,
        result: action.data
      }));
...
var reducerMap = defineProperty_default()({
  router: react_router_redux_lib["routerReducer"]
}, ids_ids.rootNodeOfStore, reducer_reducer);
...
var prop_types = __webpack_require__(69);
var prop_types_default = /*#__PURE__*/__webpack_require__.n(prop_types);

// EXTERNAL MODULE: ./src/components/Modal/index.less
var components_Modal = __webpack_require__(424);
...
var components_Tip = __webpack_require__(426);
...
// CONCATENATED MODULE: ./src/utils/storeFactory/base/index.js
...
var storeFactory_base_base = /*#__PURE__*/function () {
  function base(store) {
    classCallCheck_default()(this, base);
...
// CONCATENATED MODULE: ./src/utils/logFactory/base/index.js
 ...
 * @description: 日志基类
 */
var logFactory_base_base = /*#__PURE__*/function () {
...
// CONCATENATED MODULE: ./src/utils/logFactory/h5Platform/realName.js
...
function realName_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (realName_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function realName_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var realName_realName = /*#__PURE__*/function (_base) {
  ...
  function realName(prefix) {
    classCallCheck_default()(this, realName);

    return _super.call(this, prefix);
  } // 订阅“关闭实名认证”
  ...
  return realName;
}(logFactory_base_base);


// CONCATENATED MODULE: ./src/utils/logFactory/h5Platform/index.js
...
// CONCATENATED MODULE: ./src/utils/logFactory/lobby/index.js





function lobby_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (lobby_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function lobby_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
// CONCATENATED MODULE: ./src/utils/logFactory/lobbyMini/index.js





function lobbyMini_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (lobbyMini_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function lobbyMini_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
// CONCATENATED MODULE: ./src/utils/logFactory/classManager.js
...
var classManager_classManager = /*#__PURE__*/function () {
  function classManager() {
    classCallCheck_default()(this, classManager);
  }

  createClass_default()(classManager, [{
    key: "getClassByFeature",
...
// CONCATENATED MODULE: ./src/utils/logFactory/index.js
...
var logFactory_logHelper = /*#__PURE__*/function () {
  function logHelper() {
    classCallCheck_default()(this, logHelper);
  }

  createClass_default()(logHelper, null, [{
    key: "getHelperByFeature",
    // 通过feature获取助手
    value: function getHelperByFeature() {
      var feature = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'base';
      var key = "_".concat(feature);

      if (!this[key]) {
        var helperClass = classManager_classManager.Instance.getClassByFeature(feature);
        this[key] = new helperClass("".concat(feature, " >> "));
      }
...
// CONCATENATED MODULE: ./src/utils/storeFactory/h5Platform/realName.js
...
function h5Platform_realName_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (h5Platform_realName_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function h5Platform_realName_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var h5Platform_realName_realName = /*#__PURE__*/function (_base) {
  ...
  function realName(store) {
    classCallCheck_default()(this, realName);

    return _super.call(this, store);
  } // 更新实名数据
      ...
      var handleStoreChange = function handleStoreChange() {
        ...
        if (windowStatus !== oldWindowStatus) {
          if (typeof onClose === 'function') {
            realName_logHelper.realName.closeRealName();
            onClose();
          }

          realName_logHelper.realName.unsubscribeCloseRealName();
          unsubscribeCloseRealName();
        }
      };

      realName_logHelper.realName.subscribeCloseRealName();
    ...
    value: function subscribeSubmitRealName(_ref) {
      ...
      var handleStoreChange = function handleStoreChange() {
        ...
        if (result.error_code !== '0') {
          realName_logHelper.realName.submitRealNameError(result);
          alert(result.error);
        ...
        realName_logHelper.realName.submitRealNameSuccess();
        alert('实名认证成功！');
        ...
        realName_logHelper.realName.unsubscribeSubmitRealName();
        unsubscribeSubmitRealName();
        return;
      };

      realName_logHelper.realName.subscribeSubmitRealName();
      var unsubscribeSubmitRealName = this.store.subscribe(handleStoreChange);
    }
  }]);

  return realName;
}(storeFactory_base_base);


// CONCATENATED MODULE: ./src/utils/storeFactory/h5Platform/popup.js
...
function popup_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (popup_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
...
// CONCATENATED MODULE: ./src/utils/storeFactory/h5Platform/index.js
...
function h5Platform_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (h5Platform_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function h5Platform_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var storeFactory_h5Platform_h5Platform = /*#__PURE__*/function (_base) {
  inherits_default()(h5Platform, _base);

  var _super = h5Platform_createSuper(h5Platform);

  function h5Platform(store) {
    var _this;
...
// CONCATENATED MODULE: ./src/utils/storeFactory/lobby/index.js
...
function storeFactory_lobby_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (storeFactory_lobby_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function storeFactory_lobby_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var storeFactory_lobby_lobby = /*#__PURE__*/function (_base) {
  inherits_default()(lobby, _base);

  var _super = storeFactory_lobby_createSuper(lobby);

  function lobby(store) {
    classCallCheck_default()(this, lobby);
...
// CONCATENATED MODULE: ./src/utils/storeFactory/lobbyMini/index.js
...
function storeFactory_lobbyMini_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (storeFactory_lobbyMini_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function storeFactory_lobbyMini_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var storeFactory_lobbyMini_lobbyMini = /*#__PURE__*/function (_base) {
  inherits_default()(lobbyMini, _base);

  var _super = storeFactory_lobbyMini_createSuper(lobbyMini);

  function lobbyMini(store) {
    classCallCheck_default()(this, lobbyMini);
...
// CONCATENATED MODULE: ./src/utils/storeFactory/classManager.js
...
var storeFactory_classManager_classManager = /*#__PURE__*/function () {
  function classManager() {
    classCallCheck_default()(this, classManager);
  }
  ...
  createClass_default()(classManager, [{
    ...
    value: function getClassByFeature(feature) {
      ...
      var featureMap = (_featureMap = {}, defineProperty_default()(_featureMap, features_features.h5Platform, storeFactory_h5Platform_h5Platform), defineProperty_default()(_featureMap, features_features.lobby, storeFactory_lobby_lobby), defineProperty_default()(_featureMap, features_features.lobbyMini, storeFactory_lobbyMini_lobbyMini), _featureMap);
      var result = featureMap[feature];
      return result ? result : storeFactory_base_base;
    }
  }], [{
    key: "Instance",
    get: function get() {
...
// CONCATENATED MODULE: ./src/utils/storeFactory/index.js
...
var storeInstance = store_store.Instance;

var storeFactory_storeFactory = /*#__PURE__*/function () {
  function storeFactory() {
    classCallCheck_default()(this, storeFactory);
  }

  createClass_default()(storeFactory, null, [{
    key: "getHelperByFeature",
    // 通过feature获取助手
    value: function getHelperByFeature() {
      var feature = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'base';
      ...
      if (!this[key]) {
        var helperClass = storeFactory_classManager_classManager.Instance.getClassByFeature(feature);
...
// CONCATENATED MODULE: ./src/utils/paramsFactory/base/index.js
...
var base_logHelper = logFactory_logHelper.getHelperByFeature();

var paramsFactory_base_base = /*#__PURE__*/function () {
  function base() {
    classCallCheck_default()(this, base);
  }
  /**
  ...
  createClass_default()(base, [{
    ...
    key: "haveAllKeys",
    value: function haveAllKeys(options, keys) {
      if (!this.isObjectAndNotNull(options)) {
        base_logHelper.error('参数类型错误，需要为非空对象');
        return false;
      }
      ...
      var paramError = keys.some(function (param) {
        if (typeof options[param] === 'undefined') {
          base_logHelper.error("\u7F3A\u5C11\u53C2\u6570".concat(param));
          return true;
        }
      });
    ...
    key: "keysNotNull",
    value: function keysNotNull(options, keys) {
      if (!this.isObjectAndNotNull(options)) {
        base_logHelper.error('参数类型错误，需要为非空对象');
        return false;
      }
...
// CONCATENATED MODULE: ./src/utils/paramsFactory/h5Platform/index.js
...
function paramsFactory_h5Platform_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (paramsFactory_h5Platform_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function paramsFactory_h5Platform_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var h5Platform_logHelper = logFactory_logHelper.getHelperByFeature;

var paramsFactory_h5Platform_h5Platform = /*#__PURE__*/function (_base) {
  inherits_default()(h5Platform, _base);

  var _super = paramsFactory_h5Platform_createSuper(h5Platform);
  ...
  createClass_default()(h5Platform, [{
    ...
    value: function validateRealNameParams(options) {
      if (!this.isObjectAndNotNull(options)) {
        h5Platform_logHelper.error('实名认证的参数类型异常');
        return false;
      }

      if (!this.haveAllKeys(options, ['appkey', 'qid', 'platform', 'idcard_check_type'])) {
        h5Platform_logHelper.error('实名认证缺少参数');
        return false;
      }
  ...
  return h5Platform;
}(paramsFactory_base_base);


// CONCATENATED MODULE: ./src/utils/paramsFactory/lobby/index.js





function paramsFactory_lobby_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (paramsFactory_lobby_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function paramsFactory_lobby_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }



var paramsFactory_lobby_lobby = /*#__PURE__*/function (_base) {
  inherits_default()(lobby, _base);

  var _super = paramsFactory_lobby_createSuper(lobby);
...
// CONCATENATED MODULE: ./src/utils/paramsFactory/lobbyMini/index.js





function paramsFactory_lobbyMini_createSuper(Derived) { return function () { var Super = getPrototypeOf_default()(Derived), result; if (paramsFactory_lobbyMini_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }

function paramsFactory_lobbyMini_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }



var paramsFactory_lobbyMini_lobbyMini = /*#__PURE__*/function (_base) {
  inherits_default()(lobbyMini, _base);

  var _super = paramsFactory_lobbyMini_createSuper(lobbyMini);
...
// CONCATENATED MODULE: ./src/utils/paramsFactory/classManager.js
...
var paramsFactory_classManager_classManager = /*#__PURE__*/function () {
  function classManager() {
    classCallCheck_default()(this, classManager);
  }
  ...
  createClass_default()(classManager, [{
    ...
    value: function getClassByFeature(feature) {
      ...
      var featureMap = (_featureMap = {}, defineProperty_default()(_featureMap, features_features.h5Platform, paramsFactory_h5Platform_h5Platform), defineProperty_default()(_featureMap, features_features.lobby, paramsFactory_lobby_lobby), defineProperty_default()(_featureMap, features_features.lobbyMini, paramsFactory_lobbyMini_lobbyMini), _featureMap);
      var result = featureMap[feature];
      return result ? result : paramsFactory_base_base;
    }
  }], [{
    key: "Instance",
    get: function get() {
...
// CONCATENATED MODULE: ./src/utils/paramsFactory/index.js
...
var paramsFactory_paramsFactory = /*#__PURE__*/function () {
  function paramsFactory() {
    classCallCheck_default()(this, paramsFactory);
  }

  createClass_default()(paramsFactory, null, [{
    key: "getHelperByFeature",
    // 通过feature获取助手
    value: function getHelperByFeature() {
      var feature = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'base';
      ...
      if (!this[key]) {
        var helperClass = paramsFactory_classManager_classManager.Instance.getClassByFeature(feature);
...
var components_RealName = __webpack_require__(431);
...
var PopupContainer_mapStateToProps = function mapStateToProps(state) {
  return {
    className: state.getIn([].concat(toConsumableArray_default()(featurePath), ['className'])),
    show: state.getIn([].concat(toConsumableArray_default()(featurePath), ['show'])),
    title: state.getIn([].concat(toConsumableArray_default()(featurePath), ['title'])),
    subTitle: state.getIn([].concat(toConsumableArray_default()(featurePath), ['subTitle'])),
    subTitle2: state.getIn([].concat(toConsumableArray_default()(featurePath), ['subTitle2'])),
    content: state.getIn([].concat(toConsumableArray_default()(featurePath), ['content'])),
    canClose: state.getIn([].concat(toConsumableArray_default()(featurePath), ['canClose'])),
    noMask: state.getIn([].concat(toConsumableArray_default()(featurePath), ['noMask']))
  };
};
...
/* harmony default export */ var containers_PopupContainer = (Object(lib["connect"])(PopupContainer_mapStateToProps, PopupContainer_mapDispatchToProps)(PopupContainer_PopupContainer));
...
var RealNameContainer_mapStateToProps = function mapStateToProps(state) {
  return {
    show: state.getIn([].concat(toConsumableArray_default()(RealNameContainer_featurePath), ['show'])),
    canClose: state.getIn([].concat(toConsumableArray_default()(RealNameContainer_featurePath), ['canClose'])),
    // 提交实名认证时需要传递的一些参数
    options: state.getIn([].concat(toConsumableArray_default()(RealNameContainer_featurePath), ['options']))
  };
};
...
var containers_LobbyContainer = __webpack_require__(433);
...
var LobbyContainer_mapStateToProps = function mapStateToProps(state) {
  return {
    className: state.getIn([].concat(toConsumableArray_default()(LobbyContainer_featurePath), ['className'])),
    show: state.getIn([].concat(toConsumableArray_default()(LobbyContainer_featurePath), ['show'])),
    title: state.getIn([].concat(toConsumableArray_default()(LobbyContainer_featurePath), ['title'])),
    subTitle: state.getIn([].concat(toConsumableArray_default()(LobbyContainer_featurePath), ['subTitle'])),
    content: state.getIn([].concat(toConsumableArray_default()(LobbyContainer_featurePath), ['content']))
  };
};
...
var containers_LobbyMiniContainer = __webpack_require__(435);
...
var LobbyMiniContainer_mapStateToProps = function mapStateToProps(state) {
  return {
    className: state.getIn([].concat(toConsumableArray_default()(LobbyMiniContainer_featurePath), ['className'])),
    show: state.getIn([].concat(toConsumableArray_default()(LobbyMiniContainer_featurePath), ['show'])),
    title: state.getIn([].concat(toConsumableArray_default()(LobbyMiniContainer_featurePath), ['title'])),
    subTitle: state.getIn([].concat(toConsumableArray_default()(LobbyMiniContainer_featurePath), ['subTitle'])),
    content: state.getIn([].concat(toConsumableArray_default()(LobbyMiniContainer_featurePath), ['content'])),
    onClickOk: state.getIn([].concat(toConsumableArray_default()(LobbyMiniContainer_featurePath), ['onClickOk']))
  };
};
...
var Home_mapStateToProps = function mapStateToProps(state) {
  return {
    feature: state.getIn([].concat(toConsumableArray_default()(rootPath), ['global', 'feature'])),
    showRealName: state.getIn([].concat(toConsumableArray_default()(Home_featurePath), ['realName', 'show'])),
    showPopup: state.getIn([].concat(toConsumableArray_default()(Home_featurePath), ['popup', 'show']))
  };
};
...
var app_storeInstance = store_store.Instance;
...
var storeHelper = storeFactory_storeFactory.getHelperByFeature(features_features.h5Platform);

var popupView_setPopupData = function setPopupData(data) {
  return storeHelper.popup.setPopupData(data);
};
...
var realNameView_feature = features_features.h5Platform;
var realNameView_storeHelper = storeFactory_storeFactory.getHelperByFeature(realNameView_feature);
var realNameView_logHelper = logFactory_logHelper.getHelperByFeature(realNameView_feature);
var paramsHelper = paramsFactory_paramsFactory.getHelperByFeature(realNameView_feature);

var realNameView_updateRealNameData = function updateRealNameData(data) {
  return realNameView_storeHelper.realName.updateRealNameData(data);
};
...
var realNameView_realNameView = /*#__PURE__*/function () {
  ...
  createClass_default()(realNameView, [{
    key: "closeRealName",
    value: function closeRealName() {
      realNameView_logHelper.h5PlatformLog.realNameLog.closeRealName();
    ...
    value: function showRealName(_ref) {
      ...
      var appkey = _ref.appkey,
          ...
          onSubmitError = _ref.onSubmitError;
      // 验证参数是否合法
      var pass = paramsHelper.validateRealNameParams({
        appkey: appkey,
        qid: qid,
        platform: platform,
        idcard_check_type: idcard_check_type
      ...
      realNameView_storeHelper.realName.subscribeCloseRealName(onClose);
      realNameView_storeHelper.realName.subscribeSubmitRealName({
...
var lobby_storeHelper = storeFactory_storeFactory.getHelperByFeature(features_features.lobby);
var lobby_NoticeName = '《关于防止未成年人沉迷网络游戏的通知》';

var lobby_setLobbyData = function setLobbyData(data) {
  return lobby_storeHelper.setLobbyData(data);
};
...
var lobbyMini_storeHelper = storeFactory_storeFactory.getHelperByFeature(features_features.lobbyMini);

var lobbyMini_setLobbyMiniData = function setLobbyMiniData(data) {
  return lobbyMini_storeHelper.setLobbyMiniData(data);
}; // 通知名称
...
var h5Platform_feature = features_features.h5Platform;
var realNameModelDataInstance = realNameModelData_realNameModelData.Instance;
var h5Platform_paramsHelper = paramsFactory_paramsFactory.getHelperByFeature(h5Platform_feature);
var data_h5Platform_logHelper = logFactory_logHelper.getHelperByFeature(h5Platform_feature);
...
var h5Platform_h5PlatformData = /*#__PURE__*/function () {
  createClass_default()(h5PlatformData, null, [{
    ...
    value: function fetchRealName(_ref) {
      ...
      return new Promise(function (resolve, reject) {
        // 验证参数是否合法
        var pass = h5Platform_paramsHelper.haveAllKeys({
          appkey: appkey,
          qids: qids,
          platform: platform,
          idcard_check_type: idcard_check_type
    ...
    value: function checkAmount(_ref2) {
      ...
      var amount = _ref2.amount,
          gkey = _ref2.gkey;
      return new Promise(function (resolve, reject) {
        var pass = h5Platform_paramsHelper.keysNotNull({
          amount: amount,
          gkey: gkey
        });
    ...
    value: function storeCheckAmountResult(res) {
      try {
        ...
        data_h5Platform_logHelper.error('存储金额验证结果信息时出现异常', error);
      }
    }
  }]);
...
var lobbyMini_paramsHelper = paramsFactory_paramsFactory.getHelperByFeature(features_features.lobbyMini);
...
var lobbyMini_lobbyMiniData = /*#__PURE__*/function () {
  createClass_default()(lobbyMiniData, null, [{
    ...
    value: function checkCharge(_ref) {
      ...
      return new Promise(function (resolve, reject) {
        // 验证参数是否合法
        var pass = lobbyMini_paramsHelper.keysNotNull({
          gkey: gkey,
          exts: exts
        });
...
var unRealNameHandler_logHelper = logFactory_logHelper.getHelperByFeature(features_features.h5Platform);
...
var unRealNameHandler_unRealNameHandler = /*#__PURE__*/function () {
  createClass_default()(unRealNameHandler, null, [{
    ...
    value: function exec() {
      ...
      unRealNameHandler_logHelper.log('未实名');
...
var nonageHandler_logHelper = logFactory_logHelper.getHelperByFeature(features_features.h5Platform);
...
var nonageHandler_nonageHandler = /*#__PURE__*/function () {
  createClass_default()(nonageHandler, null, [{
    key: "exec",
    value: function exec() {
      nonageHandler_logHelper.log('已实名，未成年');
      ...
      if (nonageHandler_realNameModelDataInstance.ageLimitIsOpen()) {
        ...
        if (status === 1) {
          nonageHandler_logHelper.log('允许充值');
        } else {
          nonageHandler_logHelper.error("\u7981\u6B62\u5145\u503C: status:".concat(status, ", age: ").concat(age));
      ...
      if (nonageHandler_realNameModelDataInstance.canRechargeTime()) {
        nonageHandler_logHelper.log('在允许充值时间段内');
      } else {
        nonageHandler_logHelper.error('在禁止充值时间段内'); // 在禁止充值时间段内给出提示
...
var adultHandler_logHelper = logFactory_logHelper.getHelperByFeature(features_features.h5Platform);

var adultHandler_adultHandler = /*#__PURE__*/function () {
  createClass_default()(adultHandler, null, [{
    key: "exec",
    value: function exec() {
      adultHandler_logHelper.log('已实名，已成年');
    }
  }]);
...
var handler_h5Platform_logHelper = logFactory_logHelper.getHelperByFeature(features_features.h5Platform);
  ...
  createClass_default()(h5PlatformHandler, null, [{
    ...
    value: function getHandler() {
      ...
      if (['0', '1', '2'].indexOf(status) === -1) {
        handler_h5Platform_logHelper.error('用户的实名状态参数异常');
        return null;
      }
...
var allowChargeHandler_logHelper = logFactory_logHelper.getHelperByFeature(features_features.lobbyMini);
...
var allowChargeHandler_allowChargeHandler = /*#__PURE__*/function () {
  ...
  createClass_default()(allowChargeHandler, [{
    key: "exec",
    value: function exec() {
      allowChargeHandler_logHelper.log('允许充值');
    }
  }]);
...
var forbidChargeHandler_logHelper = logFactory_logHelper.getHelperByFeature(features_features.lobbyMini);
...
var forbidChargeHandler_forbidChargeHandler = /*#__PURE__*/function () {
  ...
  createClass_default()(forbidChargeHandler, [{
    ...
    value: function exec(callBack) {
      forbidChargeHandler_logHelper.log('禁止充值');
...
var lobbyMini_logHelper = logFactory_logHelper.getHelperByFeature(features_features.lobbyMini);
  ...
  createClass_default()(lobbyMiniHandler, null, [{
    ...
    value: function getHandler(_ref) {
      ...
      if ([1, 2, 3].indexOf(status) === -1) {
        lobbyMini_logHelper.error("\u5145\u503C\u72B6\u6001\u53C2\u6570\u5F02\u5E38\uFF0C\u5F53\u524D\u7684\u5145\u503C\u72B6\u6001\u4E3A".concat(status, "\u3002"));
        return null;
      }
...
var features_h5Platform_feature = features_features.h5Platform;
...
var h5Platform_storeHelper = storeFactory_storeFactory.getHelperByFeature(features_h5Platform_feature);
var features_h5Platform_paramsHelper = paramsFactory_paramsFactory.getHelperByFeature(features_h5Platform_feature);

var features_h5Platform_h5Platform = /*#__PURE__*/function () {
  createClass_default()(h5Platform, null, [{
    key: "Instance",
  ...
  createClass_default()(h5Platform, [{
    ...
    value: function init(_ref3) {
      ...
      h5Platform_storeHelper.updateGlobalData({
        feature: features_h5Platform_feature
      });
    ...
    value: function config(_ref4) {
      ...
      // 验证参数是否合法
      var pass = features_h5Platform_paramsHelper.validateRealNameParams({
        appkey: appkey,
        qid: qid,
        platform: platform,
        idcard_check_type: idcard_check_type
...
var lobby_feature = features_features.lobby;
var lobbyViewInstance = lobby_lobbyView.Instance;
var features_lobby_storeHelper = storeFactory_storeFactory.getHelperByFeature(lobby_feature);

var features_lobby_lobby = /*#__PURE__*/function () {
  ...
  createClass_default()(lobby, [{
    ...
    value: function init(_ref3) {
      var containerId = _ref3.containerId;
      features_lobby_storeHelper.updateGlobalData({
        feature: lobby_feature
      });
      domHelper_domHelper.initSdkElement(containerId);
      app_appView.renderApp();
    } // 年龄小于8周岁的提示
...
var lobbyMini_feature = features_features.lobbyMini;
var lobbyMini_lobbyMiniViewInstance = lobbyMini_lobbyView.Instance;
var features_lobbyMini_storeHelper = storeFactory_storeFactory.getHelperByFeature(lobbyMini_feature);

var features_lobbyMini_lobbyMini = /*#__PURE__*/function () {
  ...
  createClass_default()(lobbyMini, [{
    ...
    value: function init(_ref3) {
      var containerId = _ref3.containerId;
      features_lobbyMini_storeHelper.updateGlobalData({
        feature: lobbyMini_feature
      });
      domHelper_domHelper.initSdkElement(containerId);
      app_appView.renderApp();
    } // 年龄小于8周岁的提示
...
var sdk_features_features = /*#__PURE__*/function () {
  createClass_default()(features, null, [{
    ...
    value: function getFeatureClass(feature) {
      ...
      var featuresMap = (_featuresMap = {}, defineProperty_default()(_featuresMap, features_features.h5Platform, features_h5Platform_h5Platform), defineProperty_default()(_featuresMap, features_features.lobby, features_lobby_lobby), defineProperty_default()(_featuresMap, features_features.lobbyMini, features_lobbyMini_lobbyMini), _featuresMap);
      return featuresMap[feature] ? featuresMap[feature] : features_h5Platform_h5Platform;
    }
  }]);
  ...
  createClass_default()(RealNamePc, null, [{
    ...
    value: function Instance(_ref) {
      ...
      if (!this._instance) {
        ...
        this._instance = featureClass.Instance({
          containerId: containerId
        });
      }
